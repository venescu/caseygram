...
def create_objects(sender, instance, created, **kwargs):
    caseygramMainUser = User.objects.get(id=1)
    if created:
        Message.objects.create(sender=caseygramMainUser, receiver=instance, content='Welcome to Caseygram! This is your inbox! Click me to view our conversation.')
        ...
        PostImage.objects.create(post=post, modelimage='post_images/yellow_test.jpg')
...
def delete_notifications(sender, instance, **kwargs):
    qs = Notification.objects.get(target_object_id=instance.pk)
    qs.delete()
